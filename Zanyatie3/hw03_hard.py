...
converted_year = None if len(converted_date[2]) != 4 or 9999 < int(converted_date[2]) < 1 else int(converted_date[2])
...
while N > 0:
    ...
    floor += 1
    room += 1
print(f'Номер этажа: {answer_floor}. Номер комнаты: {answer_room}')