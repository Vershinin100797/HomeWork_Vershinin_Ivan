...
a = [2, -5, 8, 9, -25, 25, 4]
f = [int(math.sqrt(i)) for i in a if i>0 and math.sqrt(i)%1 == 0]
print(f)
...
input_data = input('Введите дату в формате dd.mm.yyyy')
...
print([randint(-100, 100) for i in range(int(input('Введите количество эллементов списка: \n')))])
...
first_list = list(set(my_list))
second_list = [i for i in my_list if my_list.count(i) == 1]
print(first_list,'\n' ,second_list)
